...
namespace Rep3.nwindDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Rep3.Properties.Settings.Default.nwindConnectionString;
        }
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, Un" +
                "itPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, EAN13\r\nFROM    " +
                "        Products";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual int FillBy(nwindDataSet.ProductsDataTable dataTable, global::System.Nullable<int> CategoryID) {
        ...
        public virtual nwindDataSet.ProductsDataTable GetDataBy(global::System.Nullable<int> CategoryID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((CategoryID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CategoryID.Value));
            }
