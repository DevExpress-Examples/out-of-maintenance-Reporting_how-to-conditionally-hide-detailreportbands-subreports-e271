...
Namespace Rep3
	...
	End Class
End Namespace
Namespace Rep3.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, Un" & "itPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, EAN13" & Constants.vbCrLf & "FROM    " & "        Products"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
			Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(1).Connection = Me.Connection
			Me._commandCollection(1).CommandText = "SELECT        ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, Un" & "itPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, EAN13" & Constants.vbCrLf & "FROM    " & "        Products" & Constants.vbCrLf & "Where CategoryID= ?"
			Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
			Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("CategoryID", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "CategoryID", Global.System.Data.DataRowVersion.Current, False, Nothing))
		End Sub
		...
		Public Overridable Function FillBy(ByVal dataTable As nwindDataSet.ProductsDataTable, ByVal CategoryID As Global.System.Nullable(Of Integer)) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(1)
			If (CategoryID.HasValue = True) Then
				Me.Adapter.SelectCommand.Parameters(0).Value = (CInt(Fix(CategoryID.Value)))
			Else
		...
		Public Overridable Function GetDataBy(ByVal CategoryID As Global.System.Nullable(Of Integer)) As nwindDataSet.ProductsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(1)
			If (CategoryID.HasValue = True) Then
				Me.Adapter.SelectCommand.Parameters(0).Value = (CInt(Fix(CategoryID.Value)))
			Else
